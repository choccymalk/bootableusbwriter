...
namespace FormatVolumeMethod2
{
    class FormatLeDiskMethod2
    {
        static public bool FormatDriveMethod2(string driveLetter, string fileSystem = "FAT32", bool quickFormat = true,
